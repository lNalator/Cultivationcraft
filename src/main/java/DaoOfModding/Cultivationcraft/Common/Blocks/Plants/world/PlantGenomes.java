...
public class PlantGenomes {
    ...
    public static PlantGenome forWorldPos(Level level, BlockPos pos) {
        ...
        if (level.isClientSide) {
            ...
            return new PlantGenome(0, 0x88CC44, 4, 0.08f, 14, false, false, new ResourceLocation("cultivationcraft","cultivationcraft.elements.none"), 1);
        }
        ...
        return e != null ? e.genome : new PlantGenome(0, 0x88CC44, 4, 0.08f, 14, false, false, new ResourceLocation("cultivationcraft","cultivationcraft.elements.none"), 1);
    }
